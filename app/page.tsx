...
export default function Home() {
  ...
  return (
    <div className="w-full bg-black text-white overflow-x-hidden">
      {/* Hero Section */}
      <main className="flex min-h-screen flex-col items-center justify-center text-center px-4 md:px-8 relative">
        <motion.div
          initial="hidden"
          animate="show"
          viewport={{ once: true }}
        ...
        >
          ...
          <motion.p variants={FADE_UP_ANIMATION_VARIANTS} className="mt-8 max-w-3xl mx-auto text-lg md:text-xl text-gray-300 leading-relaxed">
            A community for those who code, research, and launch the next generation of AI solutions—side by side.
            <br />
            At 0xAIF, founders and engineers don’t just talk about the future. We prototype it, ship it, and push it into production.
          </motion.p>
        </motion.div>
        {/* Background Gradient */}
